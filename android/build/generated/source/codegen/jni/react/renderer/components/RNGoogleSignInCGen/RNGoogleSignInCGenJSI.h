...
public:
  ...
  virtual jsi::Value enableAppCheck(jsi::Runtime &rt, std::optional<jsi::String> debugProviderAPIKey) = 0;
...
private:
  ...
  public:
    ...
    jsi::Value enableAppCheck(jsi::Runtime &rt, std::optional<jsi::String> debugProviderAPIKey) override {
      static_assert(
          bridging::getParameterCount(&T::enableAppCheck) == 2,
          "Expected enableAppCheck(...) to have 2 parameters");

      return bridging::callFromJs<jsi::Value>(
          rt, &T::enableAppCheck, jsInvoker_, instance_, std::move(debugProviderAPIKey));
    }
  ...
  class JSI_EXPORT NativeOneTapSignInCxxSpecJSI : public TurboModule {
protected:
  NativeOneTapSignInCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker);

public:
  virtual jsi::Value signIn(jsi::Runtime &rt, jsi::Object params) = 0;
  virtual jsi::Value signOut(jsi::Runtime &rt) = 0;
  virtual jsi::Value revokeAccess(jsi::Runtime &rt) = 0;
  virtual jsi::Value explicitSignIn(jsi::Runtime &rt, jsi::Object params) = 0;
  virtual jsi::Value checkPlayServices(jsi::Runtime &rt, bool showErrorResolutionDialog) = 0;
  virtual jsi::Value requestAuthorization(jsi::Runtime &rt, jsi::Object params) = 0;

};

template <typename T>
class JSI_EXPORT NativeOneTapSignInCxxSpec : public TurboModule {
public:
  jsi::Value create(jsi::Runtime &rt, const jsi::PropNameID &propName) override {
    return delegate_.create(rt, propName);
  }
  ...
  static constexpr std::string_view kModuleName = "RNOneTapSignIn";

protected:
  NativeOneTapSignInCxxSpec(std::shared_ptr<CallInvoker> jsInvoker)
    : TurboModule(std::string{NativeOneTapSignInCxxSpec::kModuleName}, jsInvoker),
      delegate_(reinterpret_cast<T*>(this), jsInvoker) {}


private:
  class Delegate : public NativeOneTapSignInCxxSpecJSI {
  public:
    Delegate(T *instance, std::shared_ptr<CallInvoker> jsInvoker) :
      NativeOneTapSignInCxxSpecJSI(std::move(jsInvoker)), instance_(instance) {
    ...
    jsi::Value explicitSignIn(jsi::Runtime &rt, jsi::Object params) override {
      static_assert(
          bridging::getParameterCount(&T::explicitSignIn) == 2,
          "Expected explicitSignIn(...) to have 2 parameters");

      return bridging::callFromJs<jsi::Value>(
          rt, &T::explicitSignIn, jsInvoker_, instance_, std::move(params));
    }
    jsi::Value checkPlayServices(jsi::Runtime &rt, bool showErrorResolutionDialog) override {
      static_assert(
          bridging::getParameterCount(&T::checkPlayServices) == 2,
          "Expected checkPlayServices(...) to have 2 parameters");

      return bridging::callFromJs<jsi::Value>(
          rt, &T::checkPlayServices, jsInvoker_, instance_, std::move(showErrorResolutionDialog));
    }
    jsi::Value requestAuthorization(jsi::Runtime &rt, jsi::Object params) override {
      static_assert(
          bridging::getParameterCount(&T::requestAuthorization) == 2,
          "Expected requestAuthorization(...) to have 2 parameters");

      return bridging::callFromJs<jsi::Value>(
          rt, &T::requestAuthorization, jsInvoker_, instance_, std::move(params));
    }

  private:
    friend class NativeOneTapSignInCxxSpec;
    T *instance_;
  };
