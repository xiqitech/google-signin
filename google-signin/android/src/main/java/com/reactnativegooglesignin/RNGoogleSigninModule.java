...
import static com.reactnativegooglesignin.modern.PromiseWrapper.ASYNC_OP_IN_PROGRESS;
import static com.reactnativegooglesignin.modern.RNOneTapSignInModule.ONE_TAP_START_FAILED;
...
import com.reactnativegooglesignin.modern.PromiseWrapper;
...
public class RNGoogleSigninModule extends NativeGoogleSigninSpec {
    ...
    @Override
    public void enableAppCheck(@Nullable String debugProviderWithAPIKey, Promise promise) {
        // ios only
        promise.resolve(null);
    }
    ...
    private static class AccessTokenRetrievalTask extends AsyncTask<WritableMap, Void, Void> {
        ...
        private void attemptRecovery(RNGoogleSigninModule moduleInstance, Exception e, WritableMap userProperties) {
            Activity activity = moduleInstance.getReactApplicationContext().getCurrentActivity();
            if (activity == null) {
