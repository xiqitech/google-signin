...
import type { CancelledResponse, NativeModuleError, NoSavedCredentialFound, SignInResponse, SignInSilentlyResponse, SignInSuccessResponse } from './types';
/**
 ...
 * @hidden so that docs are shorter
 * */
export declare function isSuccessResponse(response: SignInResponse | SignInSilentlyResponse): response is SignInSuccessResponse;
