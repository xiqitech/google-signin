declare function unsupported(): Promise<never>;
export declare const OneTapNativeModule: {
    signIn: typeof unsupported;
...
export {};
//# sourceMappingURL=NativeOneTapSignIn.d.ts.map